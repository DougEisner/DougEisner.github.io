...
function replaceContents(view) {
  var content = {
    ...
    registration: '<span class="close">&times;</span><h4>Register</h4><input type="text" name="academic_name" id="name" placeholder="Name"/><input type="text" name="academic_email" id="email" placeholder="Email"/><input type="text" name="academic_organization" id="organization" placeholder="Institution"/><select name="academic_research_area" id="research" placeholder="Institution"><option value="" disabled selected>Select Research Area</option><option value="pharmaceutical">Pharmaceutical</option><option value="bioinformatics">Bioinformatics</option><option value="plant biology">Plant Biology</option><option value="biochemistry">Biochemistry</option></select><input type="password" name="academic_password" id="password" placeholder="Password"/><input type="password" name="academic_password_confirmation" id="password_confirmation" placeholder="Password Confirmation"/><input type="submit" value="Register"/><p class="message">Already Registered? <a class="login" href="#">Log In</a></p>'
  }
