...
function addStyles() {
  ...
  addCSSRule(sheet, ".login-form .close-btn", "background: #fff; border: none; font-size: 2em; position: absolute; top: 5px; right: 10px; color: #999; cursor: pointer; outline: none;", 0);
  addCSSRule(sheet, ".login-form .close-btn:hover", "color: goldenrod", 0);
  addCSSRule(sheet, ".login-form select", "height: 40px; margin: 0 0 15px; width: 100%;", 0);
}

function replaceFormContents(form) {
  fadeIn(form);
  ...
  form.innerHTML = registrationContent;
}
